...
answers = {
    ...
    'stan': u'Predsednik će iveti u vikendici u Mladenovcu',
    ...
    'tajkun': u'Ljubiin tajkun je kum Petar Popović Ajkula',
    'sarma': u'Sarmu probo nisi.',
    'mrak': u'ta se beli u mraku Srbije?',
    'glava': u'Samo jako uzdignute glave !',
    'doktorat': u'Idem po doktorat u korporativnom industrijskom menadmentu, jer to je budućnost.',
    'placenik': u'Idem na obuku za strane plaćenike, a dogovaramo i sastanak sa Trampom',
    'sumadija': u'Tokom programa biće obavljeni i vani razgovori o potencijalnim ulaganjima nae dijaspore u AP umadija',
    'zena': u'Kad postanem preCednik, ni jedna ena ne sme biti izvređana.',
    'predskazan': u'Beli je predskazan ...',
    'prevaren': u'Da li je bilo ko od vas 12,640 kad je potpisao bio prevaren i nije znao da podrava Ljubiu Preletačevića Belog?',
    'rik': u'ao mi je to ste zabrinuti i ne verujete RIK-u.',
    'zemun': u'Znači uspeo sam da ispotujem Zemun. Ispotujte i vi brata. ',
    'sirotinja': u'Sirotinja uzvraća udarac',
    'mart': u'ene moje srećan osmi mart. Ljubi čika iarkice',
    ...
    'interes': u'Ja gledam da imam svoj lični interes, ali da dam i narodu. Sutina je da ću krasti, da ću se vajditi, ali i da ću dati narodu. Tako treba raditi i tako smo namireni i mi i oni',
    ...
    'glasanje': u'Treba da izađete na izbore, jako je bitno. Dosta ste sedeli kući, nita niste radili. Sutina je da sada uradite neto novo i bitno, izađite 2. aprila na izbore i zaokruite broj pet  ; Ljubia Preletačević Beli. Ljubi čika, bez sikiranje',
    'kosovo': u'Izvolite, moete da se vratite, ne samo vi, već i Bugarska, Grčka Od Mađarske do Grčke da se svi ujedinimo',
    'mmf': u'Ne znam ko to dri. Lepo out, izlazi iz zemlje, a sva lova kod čike. Narod zna da je lova kod mene, treba ti neto, dođe kod mene, pita treba mi za to i to, ja iskeiram sve iz depa, odem provjerim da li si to uradio i lijepo',
    'ljubi': u'Ljubi čika, bez sikiranja',
    'loto': u'Loto je čika Beli namestio. Dosta su drugi nametali loto, sad malo čika. Da usrećim kojeg Mladenovčanina, biće toga jo. Ljubi predsednik.',
    ...
    'kontrola': u'Nema tu kontrole, znači, mojih botova ima mnogo vie od ostalih stranaka i tu nema neke preterane kontrole, podelimo im te kaprićoze i oni se malo smire, ali opet krenu, mnogo su jaki, ko god krene na mene, oni me brane.',
    'krug': u'Sad idemo u krug, sad malo ja deset godina, pa će neko drugi. Nema tu neke filozofije, razume.',
    ...
    'dama': u' Postoji prva dama. Mislim ona nije jo prva dama, ja kada postanem prvi predsednik, onda ću je uzeti za enu.',
    'zelenas': u'Nema tu kancelarije, ti dođe kod mene lično, trai od mene pare. Znači nema ti da trai ni od koga drugog, pare će da budu kod mene kući, ti dođe kod mene pa trai pare. Sad, ti si seljak čovek hoće da poseje njivu neku tamo, kupi kombajn, dođe kod mene i trai, ja odem posle i proverim jesi li kupio i to je to. To je prosto.',
    'jezik': u'Dakle engleski, nemački, francuski.',
    'veselje': u'Napraviću opte narodno veselje. Napravićemo 20 mangala za 20 bravova i opte narodno veselje da proslavimo predsednikovu pobedu, onako narodski to se kae.',
    'nikolic': u'Pa verovatno bolje igram od Nikolica, imam smisla za igranku, ene kau da sam zgodan, tako da, za početak, i tri strana jezika, a spreman sam da naučim jo dva, mislim da je to za početak dovoljno.',
    ...
    'arapi': u'Kad postanem predsednik neću da radim nita, ta ima da radim, da potpisujem tamo, da igram sa Arapima, da pečem rakiju, da se etam ambasadama. Sad da izguram ovo po 22 sata da radim i posle milina Boija.',
    'istina': u'Kako neće, ljudima treba istina, niko nije bio iskren 20-30 godina, ja izađem i kaem, kao to sam tebi rekao malopre, moj lični interes je na prvom mestu, pa onda drugi, ali ja ću davati i njima.',
    'srdja': u'Ja sam iao na privatne časove kod Srđe, 1000 dinara po času je bilo i uz to mi je matematiku predavao, jedan od koeficijenata je 2, to ti je dovoljno da bude predsednik drave. Tako da to je sve po tom principtu.',
    'kabinet': u'Vidi da ja irim ljubav, nema haosa. Ja ne elim ljude na ulici, elim sebe u predsedničkom kabinetu.',
    'lgbt': u'To je ono to ti kaem, znači ako je potrebno i to da se uradi samo da ja postanem predsednik, nije nikakav problem. to se mene tiče mogu goli ljudi da etaju ulicama, ako ću ja da budem presednik drave. Samo za taj lični interes, ta god, treba da se uradi. Samo da se dođe do cilja.',
    'ujedini': u'Pa ja bih potpisao da se ujedinimo svi komplet od Mađarske dole do Grčke. Sve ako moe da se to ujedini u jednu zemlju, bez razmiljanja. Niko da se ne otcepljuje.',
    'golf': u'Golf dvica, 1.6 td, 86. godite, znači jednom mi je nestalo goriva dole na primorju sipao sam karton zejtina, je li veruje da je dogurao do Beograda?',
    'referendum': u'Ko vie nudi love, prijatelju, tamo treba da idemo. Sad da li to bila Evropska unija ili unija Azije i Severne Koreje, to je nebitno. Ja to kaem, da ne bude da je moje miljenje, referendum pa nek narod odluči. Poteno.',
    'jeremic': u'Divan momak, stvarno legendica, divan dečak, radi svoj posao kako treba.',
    'jankovic': u'Fin momak i Saa je stvarno fin dečak. On je bio bee zatitnik građana, to nije loa funkcija.',
    'radulovic': u'Oduevio me čovek to je pozivao da ljudi potpiu za nas, hvala mu za to.',
    'bosko': u'Boko je momak i po. Ne pratim neto njegove političke aktivnosti, ali ovako je stvarno fin čovek.',
    'gandalf': u'Gandalf Beli. Rekao je Tarabić da će da dođe čovek na belom konju, ne znam da li je rekao u belom odelu. Ali belo kao čisto neto je prepoznatljivo.',
    'preletacevic': u'Nijedan se ne preziva Preletačević osim mene. Ja opet u svom prezimenu imam iskrenost, razume, ja kaem da sam Preletačević. To je sutina.',
}
...
qa_dict = {
    ...
    u'tarabić': answers['gandalf'],
    'preletacevic': answers['preletacevic'],
    u'preletačević': answers['preletacevic']
}
